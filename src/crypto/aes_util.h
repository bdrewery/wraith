...
bd::String encrypt_string_cbc(const bd::String&, bd::String, bd::String = bd::String(size_t(16), 0));
bd::String decrypt_string(const bd::String&, const bd::String&);
bd::String decrypt_string_cbc(const bd::String&, bd::String, bd::String = bd::String(size_t(16), 0));
#endif
