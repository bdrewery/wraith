...
static void detect_offense(Member*, struct chanset_t *, char *);
...
static void do_closed_kick(struct chanset_t *, Member *);
...
static int msgc_dcc(Auth *, char *, char *, char *);
void unset_im(struct chanset_t* chan);
void detected_drone_flood(struct chanset_t* chan, Member*);
