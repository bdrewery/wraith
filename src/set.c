...
static variable_t vars[] = {
 ...
 VAR("ident-botnick",   &ident_botnick,		VAR_BOOL|VAR_NOLHUB,				0, 1, "0"),
 VAR("in-bots",		&in_bots,		VAR_INT|VAR_NOLOC,				1, MAX_BOTS, "2"),
 VAR("irc-autoaway",	&irc_autoaway,		VAR_BOOL|VAR_NOLHUB,				0, 1, "1"),
 ...
 VAR("link_cleartext",	&link_cleartext,	VAR_BOOL|VAR_NOLOC,				0, 1, "0"),
 VAR("login",		&login,			VAR_INT|VAR_DETECTED,				0, 4, "warn"),
 VAR("manop-warn",	&manop_warn,		VAR_BOOL|VAR_NOLHUB,				0, 1, "1"),
 ...
 VAR("oidentd",		&oidentd,		VAR_BOOL|VAR_NOLHUB,				0, 1, "0"),
